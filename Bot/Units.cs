...
internal static class Units
{
    ...
    public static readonly HashSet<uint> Zerg = new()
    {
        INFESTOR_TERRAN,
        BANELING_COCOON,
        BANELING,
    ...
    public static readonly HashSet<uint> Terran = new()
    {
        HELLBAT,
        LIBERATOR,
        WIDOW_MINE,
    ...
    public static readonly HashSet<uint> Protoss = new()
    {
        ADEPT,
        COLOSSUS,
        MOTHERSHIP,
    ...
    public static readonly HashSet<uint> Structures = new()
    {
        ARMORY,
        ASSIMILATOR,
        BANELING_NEST,
    ...
    public static readonly HashSet<uint> Production = new()
    {
        ARMORY,
        BANELING_NEST,
        BARRACKS,
    ...
    public static readonly HashSet<uint> ResourceCenters = new()
    {
        COMMAND_CENTER,
        COMMAND_CENTER_FLYING,
        HATCHERY,
    ...
    public static readonly HashSet<uint> MineralFields = new()
    {
        RICH_MINERAL_FIELD,
        RICH_MINERAL_FIELD_750,
        MINERAL_FIELD,
    ...
    public static readonly HashSet<uint> Workers = new()
    {
        SCV,
        PROBE,
        DRONE
    ...
    public static readonly HashSet<uint> Liftable = new()
    {
        COMMAND_CENTER,
        ORBITAL_COMMAND,
        BARRACKS,
    ...
    public static readonly HashSet<uint> StaticAirDefense = new()
    {
        PHOTON_CANNON,
        MISSILE_TURRET,
        SPORE_CRAWLER,
    ...
    public static readonly HashSet<uint> StaticGroundDefense = new()
    {
        PHOTON_CANNON,
        BUNKER,
        SPINE_CRAWLER,
    ...
    public static readonly HashSet<uint> SiegeTanks = new()
    {
        SIEGE_TANK,
        SIEGE_TANK_SIEGED
    };

    public static readonly HashSet<uint> Vikings = new()
    {
        VIKING_ASSAULT,
        VIKING_FIGHTER
    };

    public static readonly HashSet<uint> FromBarracks = new()
    {
        REAPER,
        MARINE,
        MARAUDER,
    ...
    public static readonly HashSet<uint> FromFactory = new()
    {
        THOR,
        HELLION,
        HELLBAT,
